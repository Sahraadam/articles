...
<head>
    <meta charset="utf-8" />
    <title>Articles Web Platform - Super User Homepage</title>
            ...
            <nav class="navbar">
                <div class="collapse navbar-collapse single-page-nav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" onclick="myFunction2();"><span class="icn"><i class="fas fa-users" aria-hidden="true"></i></span> Manage Other Users</a>
                        </li> 
                        <li class="nav-item">
                ...
                <div class="container">
                    <div class="item">
                        ...
                        <div class="bg-blue-transparent simple"><p>Simplify the publication process with a structured workflow, ensuring smooth transitions from drafting to editing and final publication.</p> 
                            <br>
                            <a class="nav-link" href="features/user_logout.php"><span class="icn"><i class="fas fa-power-off"></i></span> Logout</a></div>
                    </div>
                </div>
            </div>
...
<td><img style="width: 50px;" src="img/<?php echo($row["profile_Image"]); ?>" title="<?php echo($row["Full_Name"]); ?>"></td>
<td><?php echo($row["UserType"]); ?></td>
<td><button class="btn btn-primary py-3 px-5" onclick="return confirm('Are you sure that you want to delete this user?')?window.location.href='features/main-features.php?action=deleteU&id=<?php echo($row["userId"]); ?>':true;" title='Delete User'><i class="fas fa-trash-alt"></i></button></td>
</tr>
<?php
}
} else { echo "No results"; }
...
<td><button class="btn btn-primary py-3 px-5" onclick="return confirm('Are you sure that you want to print this article?')?window.location.href='features/main-features?action=printA&id=<?php echo($row["article_id"]); ?>':true;" title='Print Article'><i class="fa-solid fa-print"></i></button></td>
<br>
<br>
</tr>
<?php
...
<script>
  ...
  var x2 = document.getElementById("users");
